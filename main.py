...
# --- Абсолютні шляхи до картинок ---
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

ALARM_IMAGE_DEFAULT = os.path.join(BASE_DIR, "images/alarm.jpg")
CLEAR_IMAGE = os.path.join(BASE_DIR, "images/clear.jpg")
SAFETY_IMAGE = os.path.join(BASE_DIR, "images/saefty.jpg")  # виправлено
...
DISTRICT_IMAGES = {
    "Бориспільський": os.path.join(BASE_DIR, "images/alarm_boryspil.jpg"),
    "Білоцерківський": os.path.join(BASE_DIR, "images/alarm_bila_tserkva.jpg"),
    "Броварський": os.path.join(BASE_DIR, "images/alarm_brovary.jpg"),
    "Бучанський": os.path.join(BASE_DIR, "images/alarm_bucha.jpg"),
    "Вишгородський": os.path.join(BASE_DIR, "images/alarm_vyshhorod.jpg"),
    "Обухівський": os.path.join(BASE_DIR, "images/alarm_obukhiv.jpg"),
    "Фастівський": os.path.join(BASE_DIR, "images/alarm_fastiv.jpg")
}
...
def check_alerts_loop():
    ...
    while True:
        ...
        for district in new_active_districts - active_districts:
            text = f"⚠️ Увага! У {district} районі оголошено повітряну тривогу! Будьте обережні!"
        ...
        print(f"[DEBUG] Активні райони: {sorted(active_districts)}")  # для логування
        time.sleep(25)
